...
editor: visual
toc: true
#adding a TOC for ease of viewing the HTML
---
...
#I hadn't seen an interactive graph made in R before, this is a really cool function. 
```
...
# I tried some other graph options for this but wasn't able to find one that was more accessible. The geom_point graph above is the only one that I had trouble understanding, due to the clutering of points and only values of 0 or 1. What is the message that this graph is trying to convey?
```
...
# I appreciate seeing pivot_wider in a real world use 
```
